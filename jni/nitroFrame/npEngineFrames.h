...
class npEngineFrame {
	 ...
	 *
	 * @fn npGameCreate : Process가 생성되었을 경우 호출되는 함수
	 * @fn npGameDestroy : Process가 종료되었을 경우 호출되는 함수
	 * @fn npGameLoop: 게임의 기본적인 LoopLogic
	 * @fn npGameUpdate : 게임이 계속 진행상태인 경우 호출되는 함수
	 * @fn npGamePaused : 게임의 루프로직이 일시 정지시에 호출되는 함수
	 * @fn npGameChanged : 게임의 상태가 변경되었을 경우
...
public:
	...
	//기본 Frame 함수들
	virtual void npGameCreate(JNIEnv* env,const char* apkPath);
